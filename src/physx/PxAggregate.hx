...
extern class PxAggregate extends PxBase
{
    ...
    */
    inline function getActors(userBuffer:haxe.ds.Vector<PxActor>, startIndex:PxU32 = 0):PxU32
    {
        return untyped __cpp__("{0}->getActors(reinterpret_cast<physx::PxActor**>({1}), {2}, {3})",
            this, cpp.Pointer.ofArray((userBuffer:Array<PxActor>)).ptr, userBuffer.length, startIndex);
    }
    ...
    @see PxScene
    */
    public function getScene():PxScene;
